...
public class Module extends ListenerAdapter implements Utils {
    ...
    public final Animation animation = new DecelerateAnimation(250, 1).setDirection(Direction.BACKWARDS);
    ...
    public void onDisable() {
        if (this instanceof GlowESP) {
            ...
            Multithreading.schedule(() -> YolBi.INSTANCE.getEventProtocol().unregister(this), 250, TimeUnit.MILLISECONDS);
        } else {
            YolBi.INSTANCE.getEventProtocol().unregister(this);
        }
    }

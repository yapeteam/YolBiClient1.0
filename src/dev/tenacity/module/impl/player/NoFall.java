...
public final class NoFall extends Module {
    ...
    private final ModeSetting mode = new ModeSetting("Mode", "Vanilla", "Vanilla", "Packet", "Verus","NoGround");
    private double dist;
    ...
    public void onPacketReceiveEvent(PacketReceiveEvent event){
        if (mode.is("NoGround")){
            if (event.getPacket() instanceof C03PacketPlayer){
                ...
                //event.setPacket(((C03PacketPlayer) event.getPacket()).onGround=false);
            }
        }
    }
    @Override

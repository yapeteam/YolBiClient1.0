...
public class ArrayListMod extends Module {
    ...
    public void getModulesAndSort() {
        if (modules == null || ModuleCollection.reloadModules) {
            List<Class<? extends Module>> hiddenModules = YolBi.INSTANCE.getModuleCollection().getHiddenModules();
            List<Module> moduleList = YolBi.INSTANCE.getModuleCollection().getModules();
    ...
    public Dragging arraylistDrag = YolBi.INSTANCE.createDrag(this, "arraylist", 2, 1);

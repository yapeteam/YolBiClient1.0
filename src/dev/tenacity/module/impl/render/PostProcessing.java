...
public class PostProcessing extends Module {
    ...
    public void stuffToBlur(boolean bloom) {
        ...
        if (mc.currentScreen == ClickGUIMod.dropdownClickGui || mc.currentScreen == ClickGUIMod.modernClickGui || mc.currentScreen == ClickGUIMod.compactClickgui) {
            YolBi.INSTANCE.getSideGui().drawForEffects(bloom);
            YolBi.INSTANCE.getSearchBar().drawEffects();
        }
        ...
        RenderUtil.resetColor();
        NotificationsMod notificationsMod = YolBi.INSTANCE.getModuleCollection().getModule(NotificationsMod.class);
    ...
    public void blurScreen() {
        ...
        if (blur.isEnabled()) {
            ...
            YolBi.INSTANCE.getEventProtocol().handleEvent(new ShaderEvent(false, glowOptions));
            stuffToBlur(false);
        ...
        if (bloom.isEnabled()) {
            ...
            YolBi.INSTANCE.getEventProtocol().handleEvent(new ShaderEvent(true, glowOptions));
            stuffToBlur(true);

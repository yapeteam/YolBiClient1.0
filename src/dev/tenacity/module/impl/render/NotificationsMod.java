...
public class NotificationsMod extends Module {
    ...
    public static final ModeSetting mode = new ModeSetting("Mode", "Default", "Default", "SuicideX", "Exhibition","YolBi","New");
        ...
        for (Notification notification : NotificationManager.getNotifications()) {
            ...
            switch (mode.getMode()) {
                ...
                case "YolBi":
                    ...
                    notification.drawYolBiMode(x,y, notificationWidth, notificationHeight, (float) animation.getOutput().floatValue(), onlyTitle.isEnabled());
                    break;
                case "New":
                    ...
                    notification.drawnewYolBiMode(x,y, notificationWidth, notificationHeight, (float) animation.getOutput().floatValue(), onlyTitle.isEnabled());
                    break;
            }

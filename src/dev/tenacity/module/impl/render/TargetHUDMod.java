...
public class TargetHUDMod extends Module {
    ...
    private final ModeSetting targetHud = new ModeSetting("Mode", "YolBi", "YolBi", "Old YolBi", "Rise", "Exhibition", "Auto-Dox", "Akrien", "Astolfo", "Novoline");
    ...
    private final Dragging drag = YolBi.INSTANCE.createDrag(this, "targetHud", 300, 300);
    ...
    public Pair<Float, Float> getTrackedCoords() {

...
public class FollowTarget extends Module {

    private final ModeSetting targetHud = new ModeSetting("Mode", "Novoline", "YolBi", "Old YolBi", "Rise", "Exhibition", "Auto-Dox", "Akrien", "Astolfo", "Novoline");
    ...
    public FollowTarget() {
        super("FollowTarget", Category.RENDER, "Let the target info follow the target");
    ...
    private final Dragging drag = YolBi.INSTANCE.createDrag(this, "FollowTarget", 300, 300);
    ...
    public void onPreRenderEvent(PreRenderEvent event) {
        ...
        if (killAura == null) {
            killAura = (KillAura) YolBi.INSTANCE.getModuleCollection().get(KillAura.class);
        }

...
public class PlayerList extends Module {
    ...
    private final Dragging pos = YolBi.INSTANCE.createDrag(this, "playerList", 4, 30);
    ...
    public void onRender2DEvent(Render2DEvent event) {
        ...
        FontUtil.getFromCustomFont(tenacityFont18).drawString(String.valueOf(players.size() + 1),
    ...
    private void renderPlayer(EntityPlayer player, int i, float x, float y) {
        float height = FontUtil.getFromCustomFont(tenacityFont16).getHeight() + 8;
        ...
        FontUtil.getFromCustomFont(tenacityFont16).drawStringWithShadow("§f§l" + player.getName() + "§r " + healthText, x + 18, y + offset + tenacityFont16.getMiddleOfBox(height), healthColor);
        ...
        if (player == mc.thePlayer) {
            FontUtil.getFromCustomFont(tenacityFont18).drawStringWithShadow("*", x + 139 - tenacityFont18.getStringWidth("*"), y + offset + 6.75F, HUDMod.getClientColors().getFirst().getRGB());
        }
    }
}

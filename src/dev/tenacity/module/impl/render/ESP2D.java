        ...
        if (nametagSettings.getSetting("Add PostProcessing").isEnabled() && nametags.isEnabled()) {
            for (Entity entity : entityPosition.keySet()) {
                ...
                if (entity instanceof EntityLivingBase) {
                    AbstractFontRenderer font = FontUtil.getFromCustomFont(tenacityBoldFont20);
                    if (mcfont.isEnabled()) {
            ...
            if (entity instanceof EntityLivingBase) {
                ...
                if (nametags.isEnabled()) {
                    ...
                    if (mcfont.isEnabled()) {
                        ...
                        font.drawStringWithShadow(text.toString(), middle, (float) (y - (fontHeight + 5)), healthColor.getRGB());
                    }
                    glPopMatrix();
                }
                ...
                if (itemHeld.isEnabled()) {
                    if (renderingEntity.getHeldItem() != null) {
                        ...
                        if (mcfont.isEnabled()) {
                            ...
                            font.drawStringWithShadow(text, middle, bottom + 4, -1);
                        }
                        glPopMatrix();
                    }
                }
                ...
                if (healthBar.isEnabled()) {
                    ...
                    if (healthBarText.isEnabled()) {
                        ...
                        float fontHeight = mcfont.isEnabled() ? (float) (mc.fontRendererObj.FONT_HEIGHT * fontScale) : (float) (font.getHeight() * fontScale);

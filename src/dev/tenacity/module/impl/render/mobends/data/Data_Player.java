package dev.tenacity.module.impl.render.mobends.data;
				...
				if(this.currentAttack == 0){
					...
					if(this.ticksAfterPunch < 15.0f){
						if(this.currentAttack == 1) this.currentAttack = 2;
							...
							this.currentAttack = (!((MoBendsMod) YolBi.INSTANCE.getModuleCollection().get(MoBendsMod.class)).spinAttack.getConfigValue() || this.getEntity().isRiding()) ? 1 : 3;
						}

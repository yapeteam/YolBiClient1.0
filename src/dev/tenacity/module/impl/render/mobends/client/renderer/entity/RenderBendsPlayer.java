package dev.tenacity.module.impl.render.mobends.client.renderer.entity;
...
import dev.tenacity.module.impl.render.mobends.client.renderer.entity.layers.LayerBendsCape;
import dev.tenacity.module.impl.render.mobends.client.renderer.entity.layers.LayerBendsCustomHead;
import dev.tenacity.module.impl.render.mobends.client.renderer.entity.layers.LayerBendsPlayerArmor;
...
public class RenderBendsPlayer extends RenderPlayer {
    ...
    protected void preRenderCallback(AbstractClientPlayer clientPlayer, float partialTicks) {
        ...
        if (YolBi.INSTANCE.getModuleCollection().getModule(MoBendsMod.class).swordTrail.getConfigValue()) {
            GL11.glPushMatrix();
            float f5 = 0.0625F;

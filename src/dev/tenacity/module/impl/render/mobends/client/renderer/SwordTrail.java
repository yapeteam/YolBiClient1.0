package dev.tenacity.module.impl.render.mobends.client.renderer;
...
import dev.tenacity.module.impl.render.MoBendsMod;
import dev.tenacity.module.impl.render.mobends.client.model.ModelRendererBends;
import dev.tenacity.module.impl.render.mobends.client.model.entity.ModelBendsPlayer;
import dev.tenacity.module.impl.render.mobends.util.GUtil;
...
public class SwordTrail {
	...
	public void render(ModelBendsPlayer model){
		...
		count = (int) MoBendsMod.count;
		if (YolBi.INSTANCE.getModuleCollection().getModule(MoBendsMod.class).usecolor.isEnabled()){
			if (count==1){
				Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("mobends/textures/color/1.png"));
			} else if (count==2) {
				Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("mobends/textures/color/2.png"));
			} else if (count==3) {
				Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("mobends/textures/color/3.png"));
			} else if (count==4) {
				Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("mobends/textures/color/4.png"));
			} else if (count==5) {
				Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("mobends/textures/color/5.png"));
			} else if (count==6) {
				Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("mobends/textures/color/6.png"));
			} else if (count==7) {
				Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("mobends/textures/color/7.png"));
			} else if (count==8) {
				Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("mobends/textures/color/8.png"));
			} else if (count==9) {
				Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("mobends/textures/color/9.png"));
			} else if (count==10) {
				Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("mobends/textures/color/10.png"));
			} else if (count==11) {
				Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("mobends/textures/color/11.png"));
			} else if (count==12) {
				Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("mobends/textures/color/12.png"));
			} else if (count==13) {
				Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("mobends/textures/color/13.png"));
			} else if (count==14) {
				Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("mobends/textures/color/14.png"));
			} else if (count==15) {
				Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("mobends/textures/color/15.png"));
			} else if (count==16) {
				Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("mobends/textures/color/16.png"));
			} else if (count==17) {
				Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("mobends/textures/color/17.png"));
			}

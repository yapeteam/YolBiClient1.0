...
public class GlowESP extends Module {
    ...
    private final ColorSetting playerColor = new ColorSetting("Player Color", YolBi.INSTANCE.getClientColor());
    private final ColorSetting animalColor = new ColorSetting("Animal Color", YolBi.INSTANCE.getAlternateClientColor());
    ...
    private final ShaderUtil outlineShader = new ShaderUtil("YolBi/Shaders/outline.frag");
    ...
    private Color getColor(Object entity) {
        ...
        if (entity instanceof EntityLivingBase) {
            ...
            if (entityLivingBase.hurtTime > 0) {
                //We use the first part of the sine wave to make the color more red as the entity gets hurt and animate it back to normal

...
public class OldTenacityTargetHUD extends TargetHUD {
    ...
    public void render(float x, float y, float alpha, EntityLivingBase target) {
        AbstractFontRenderer
                font26 = FontUtil.getFromCustomFont(tenacityBoldFont26),
                font32 = FontUtil.getFromCustomFont(tenacityBoldFont32),
                font16 = FontUtil.getFromCustomFont(tenacityFont16);

        setWidth(Math.max(145, tenacityBoldFont26.getStringWidth(target.getName()) + 40));
        setHeight(37);
        ...
        if (target instanceof AbstractClientPlayer) {
            ...
            font32.drawCenteredStringWithShadow("?", x + 20, y + 17 - tenacityBoldFont32.getHeight() / 2f, textColor);
        }


        font26.drawStringWithShadow(target.getName(), x + 39, y + 5, textColor);
        ...
        font16.drawStringWithShadow(healthText, x + 34 + Math.min(Math.max(1, healthWidth), realHealthWidth - 11), y + getHeight() - (14 + tenacityFont16.getHeight()), textColor);
    }

...
public class AkrienTargetHUD extends TargetHUD {
    ...
    public void render(float x, float y, float alpha, EntityLivingBase target) {
        AbstractFontRenderer rubikBold = FontUtil.getFromCustomFont(rubikFont.boldSize(18));
        AbstractFontRenderer rubikSmall = FontUtil.getFromCustomFont(rubikFont.size(13));

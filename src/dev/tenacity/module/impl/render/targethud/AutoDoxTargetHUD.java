...
public class AutoDoxTargetHUD extends TargetHUD {
    ...
    public void render(float x, float y, float alpha, EntityLivingBase target) {
        ...
        AbstractFontRenderer
                tahomaBoldFont27 = FontUtil.getFromCustomFont(tahomaFont.boldSize(27)),
                tahomaBoldFont16 = FontUtil.getFromCustomFont(tahomaFont.boldSize(16)),
                tahomaFont12 = FontUtil.getFromCustomFont(tahomaFont.size(12)),
                tahomaBoldFont10 = FontUtil.getFromCustomFont(tahomaFont.boldSize(10)),
                tahomaBoldFont14 = FontUtil.getFromCustomFont(tahomaFont.boldSize(14));
        ...
        RenderUtil.resetColor();
        FollowTarget.renderLayers = false;
        ...
        FollowTarget.renderLayers = true;

...
public class ExhiTargetHUD extends TargetHUD {
    ...
    public void render(float x, float y, float alpha, EntityLivingBase target) {
        AbstractFontRenderer font12 = FontUtil.getFromCustomFont(tahomaFont.size(12));
        AbstractFontRenderer font16 = FontUtil.getFromCustomFont(tahomaFont.size(16));
        ...
        font16.drawString(target.getName(), x + 8 + size, y + 6, textColor.getRGB());
        ...
        font12.drawString("HP: " + MathUtils.round(target.getHealth() + target.getAbsorptionAmount(), 1) + " | Dist: " + MathUtils.round(mc.thePlayer.getDistanceToEntity(target), 1),

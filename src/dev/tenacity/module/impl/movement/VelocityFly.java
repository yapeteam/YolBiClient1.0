...
public class VelocityFly extends Module {
    private final ModeSetting mode = new ModeSetting("Mode", "Packet", "Packet", "Matrix", "Tick", "Stack", "C0F Cancel");
    private final NumberSetting horizontal = new NumberSetting("Horizontal", 0, 1000, -1000, 1);
    private final NumberSetting vertical = new NumberSetting("Vertical", 0, 1000, -1000, 1);
    ...
    private int stack;
    public VelocityFly() {
        super("VelocityFly",Category.MOVEMENT,"Boost your Velocity");

...
public class SearchPanel extends Panel {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        String search = YolBi.INSTANCE.getSideGui().getHotbar().searchField.getText();
        ...
        if (!searchTypeHold.equals(searchType)) {
            switch (searchType) {
                case "Configs":
                    ...
                    cloudConfigRects.addAll(YolBi.INSTANCE.getSideGui().getConfigPanel().getCloudConfigRects());
                    break;
                case "Scripts":
                    cloudConfigRects.clear();
                    cloudScriptRects.clear();
                    cloudScriptRects.addAll(YolBi.INSTANCE.getSideGui().getScriptPanel().getCloudScriptRects());
                    break;
            }

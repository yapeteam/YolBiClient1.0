...
public class ScriptPanel extends Panel {
            ...
            button.setClickAction(() -> {
                ...
                switch (button.getName()) {
                    case "Open documentation":
                        ...
                        break;
                    case "Open folder":
                        IOUtils.openFolder(YolBi.INSTANCE.getScriptManager().getScriptDirectory());
                        break;
                }
            });
    ...
    public void refresh() {
        ...
        for (CloudScript cloudScript : YolBi.INSTANCE.getCloudDataManager().getCloudScripts()) {
        ...
        for (Script script : YolBi.INSTANCE.getScriptManager().getScripts()) {

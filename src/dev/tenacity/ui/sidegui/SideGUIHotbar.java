...
public class SideGUIHotbar implements Screen {
    ...
    @Getter
    //private final CarouselButtons carouselButtons = new CarouselButtons("Configs", "Scripts", "CloudMusic");
    private final CarouselButtons carouselButtons = new CarouselButtons("Configs", "CloudMusic","about");
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        tenacityBoldFont32.drawString(YolBi.NAME, x + 9.5f, y + tenacityBoldFont32.getMiddleOfBox(height), textColor);
        tenacityFont18.drawString(YolBi.VERSION, x + 9.5f + tenacityBoldFont32.getStringWidth(YolBi.NAME) - 2,
        ...
        if (!searching) {
            ...
            refreshButton.setClickAction(() -> Multithreading.runAsync(() -> YolBi.INSTANCE.getCloudDataManager().refreshData()));

            boolean refreshing = YolBi.INSTANCE.getCloudDataManager().isRefreshing();
            if (refreshing) {
    ...
    public void mouseClicked(int mouseX, int mouseY, int button) {
        ...
        if (!YolBi.INSTANCE.getCloudDataManager().isRefreshing() && refreshTimer.hasTimeElapsed(12000)) {

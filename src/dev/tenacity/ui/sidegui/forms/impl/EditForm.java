...
public class EditForm extends Form {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        updateButton.setClickAction(() -> {
            ...
            YolBi.INSTANCE.getSideGui().displayForm(null);
        });
        ...
        if (error) {
            tenacityFont16.drawCenteredStringWithShadow("Error please fill out the required fields",
                    ...
                    YolBi.INSTANCE.getSideGui().getRedBadColor().getRGB());
        }
        ...
        deleteButton.setColor(YolBi.INSTANCE.getSideGui().getRedBadColor());
    ...
    public void setup(CloudData data, boolean script) {
        ...
        if (script) {
            scriptFiles.setupOptions(YolBi.INSTANCE.getScriptManager().getScriptFileNameList());
        }

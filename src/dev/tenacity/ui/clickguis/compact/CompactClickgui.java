...
public class CompactClickgui extends GuiScreen {
    ...
    public void onDrag(int mouseX, int mouseY) {
        boolean focusedConfigGui = YolBi.INSTANCE.getSideGui().isFocused();
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        if (ModuleCollection.reloadModules || moduleRects == null) {
            ...
            for (Category category : Category.values()) {
                ...
                for (Module module : YolBi.INSTANCE.getModuleCollection().getModulesInCategory(category)) {
        ...
        typing = modulePanel.typing || (YolBi.INSTANCE.getSideGui().isFocused() && YolBi.INSTANCE.getSideGui().isTyping()) || YolBi.INSTANCE.getSearchBar().isTyping();
        ...
        mc.getTextureManager().bindTexture(new ResourceLocation("YolBi/YolBilogo.png"));
        Gui.drawModalRectWithCustomSizedTexture(x + 5, y + 5, 0, 0, 20.5f, 20.5f, 20.5f, 20.5f);

        FontUtil.tenacityBoldFont22.drawString(YolBi.NAME, x + 33, y + 7, -1);
        FontUtil.tenacityFont16.drawCenteredString(YolBi.VERSION,
                (float) (x + 31 + FontUtil.tenacityBoldFont22.getStringWidth(YolBi.NAME) / 2f), y + 19, -1);

        boolean searching = YolBi.INSTANCE.getSearchBar().isFocused();
        ...
        if (YolBi.INSTANCE.getDiscordAccount() != null) {
            DiscordAccount discordAccount = YolBi.INSTANCE.getDiscordAccount();
            ...
            String discordTag = YolBi.INSTANCE.getIntentAccount().discord_tag;
        ...
        ClickGUIMod clickGUIMod = YolBi.INSTANCE.getModuleCollection().getModule(ClickGUIMod.class);
        ...
        SearchBar searchBar = YolBi.INSTANCE.getSearchBar();
    ...
    public List<ModuleRect> getModuleRects(Category category) {
        ...
        String search = YolBi.INSTANCE.getSearchBar().getSearchField().getText();

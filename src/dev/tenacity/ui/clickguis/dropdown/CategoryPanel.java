...
public class CategoryPanel implements Screen {
    ...
    public void initGui() {
        if (moduleRects == null) {
            ...
            for (Module module : YolBi.INSTANCE.getModuleCollection().getModulesInCategory(category).stream().sorted(Comparator.comparing(Module::getName)).collect(Collectors.toList())) {

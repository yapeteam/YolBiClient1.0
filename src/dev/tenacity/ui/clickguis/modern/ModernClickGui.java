...
public class ModernClickGui extends GuiScreen {
    ...
    public void initGui() {
        ...
        ClickGUIMod clickMod = YolBi.INSTANCE.getModuleCollection().getModule(ClickGUIMod.class);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        typing = modpanel.isTyping() || (YolBi.INSTANCE.getSideGui().isFocused() && YolBi.INSTANCE.getSideGui().isTyping()) || YolBi.INSTANCE.getSearchBar().isTyping();
        ...
        FontUtil.tenacityFont20.drawString(YolBi.NAME, x + 35 + xAdjust, y + 13, -1);

        FontUtil.tenacityFont14.drawString(YolBi.VERSION, x + 41 + FontUtil.tenacityFont18.getStringWidth(YolBi.NAME) + xAdjust, y + 15.5f,
                new Color(98, 98, 98));

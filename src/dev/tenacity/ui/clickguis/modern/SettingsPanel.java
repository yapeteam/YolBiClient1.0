    ...
    public SettingsPanel(Module module) {
        ...
        for (Setting setting : module.getSettingsList()) {
            ...
            if (setting instanceof StringSetting) {
                ...
                TextField textField = new TextField(FontUtil.getFromCustomFont(tenacityFont18));
    ...
    public void handle(int mouseX, int mouseY, int button, GuiEvents type) {
        ...
        for (Setting setting : module.getSettingsList()) {
            ...
            if (setting instanceof ColorSetting) {
                ...
                GL11.glEnable(GL11.GL_BLEND);
                mc.getTextureManager().bindTexture(new ResourceLocation("YolBi/booleanslider1.png"));
                ...
                GL11.glEnable(GL11.GL_BLEND);
                RenderUtil.color(-1);
                mc.getTextureManager().bindTexture(new ResourceLocation("YolBi/colorpicker2.png"));
                ...
                // Hue bar
                RenderUtil.color(-1);
                mc.getTextureManager().bindTexture(new ResourceLocation("YolBi/hue.png"));

...
public enum Theme {
    ...
    TENACITY("YolBi", YolBi.INSTANCE.getClientColor(), YolBi.INSTANCE.getAlternateClientColor(), true),
    VAPE("VAPE V5", new Color(26, 25, 26), new Color(1, 254, 170)),
    RGB_RAINBOW("RainBow", HUDMod.rainbow.getColor(), HUDMod.rainbow.getColor(), true),
    ...
    public Pair<Color, Color> getColors() {
        ...
        } else if (this.equals(Theme.RGB_RAINBOW)) {
            return Pair.of(HUDMod.rainbow.getRainbow().getColor(-HUDMod.RainBowOffset.getValue().intValue()), HUDMod.rainbow.getRainbow().getColor(HUDMod.RainBowOffset.getValue().intValue()));
        } else return colors;
    }

...
public class RotationUtils implements Utils {
    ...
    public static Rotation getRotationsEntity(EntityLivingBase entity) {
        return RotationUtils.getFRotations(entity.posX, entity.posY + entity.getEyeHeight() - 0.4, entity.posZ);
    }
     ...
     * @return
     */
    public static Rotation getFRotations(double posX, double posY, double posZ) {

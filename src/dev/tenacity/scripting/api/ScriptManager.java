...
public class ScriptManager implements Utils {
    ...
    private final File scriptDirectory = new File(mc.mcDataDir, "/YolBi/Scripts");
    ...
    public void reloadScripts() {
        HashMap<Object, Module> moduleList = YolBi.INSTANCE.getModuleCollection().getModuleMap();

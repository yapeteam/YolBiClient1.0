...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void runGameLoop() throws IOException {
        ...
        if (!this.skipRenderWorld) {
            ...
            YolBi.INSTANCE.getEventProtocol().handleEvent(renderTickEvent);
    ...
    public void shutdown() {
        YolBi.INSTANCE.getEventProtocol().handleEvent(new GameCloseEvent());
        this.running = false;
    }
    ...
    public void clickMouse() {
        if (this.leftClickCounter <= 0) {
            ...
            YolBi.INSTANCE.getEventProtocol().handleEvent(e);
...
//                        this.playerController.attackEntity(this.thePlayer, this.objectMouseOver.entityHit);
    ...
    public void rightClickMouse() {
        YolBi.INSTANCE.getEventProtocol().handleEvent(new ClickEventRight());
    ...
    public void runTick() throws IOException {
        ...
        YolBi.INSTANCE.getEventProtocol().handleEvent(tickEvent);
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    if (this.currentScreen != null) {
                        ...
                        YolBi.INSTANCE.getEventProtocol().handleEvent(new KeyPressEvent(k));
            ...
            if (this.thePlayer.isUsingItem()) {
                ...
                YolBi.INSTANCE.getEventProtocol().handleEvent(blockEvent);
            ...
            YolBi.INSTANCE.getEventProtocol().handleEvent(new BlockPlaceableEvent());

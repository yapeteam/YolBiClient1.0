...
import dev.tenacity.module.impl.render.FollowTarget;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
        if (YolBi.INSTANCE.getModuleCollection().getModule(MoBendsMod.class).onRenderLivingEvent(this, entity, x, y, z, entityYaw, partialTicks)) {
            return;
        }
    ...
    protected void renderModel(T entitylivingbaseIn, float x, float y, float z, float entityYaw, float entityPitch, float scaleFactor, float partialTicks) {
        ...
        if (flag || flag1) {
            ...
            YolBi.INSTANCE.getEventProtocol().handleEvent(renderModelEvent);
    ...
    public void renderName(T entity, double x, double y, double z) {
        if (entity instanceof EntityPlayer) {
            ...
            YolBi.INSTANCE.getEventProtocol().handleEvent(nametagRenderEvent);
            if (nametagRenderEvent.isCancelled()) return;
        }
        if (esp2D == null) {
            esp2D = YolBi.INSTANCE.getModuleCollection().getModule(ESP2D.class);
        }

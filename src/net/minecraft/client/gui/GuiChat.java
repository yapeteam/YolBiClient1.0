...
public class GuiChat extends GuiScreen {
    ...
    public void initGui() {
        ...
        if (spotifyMod == null) {
            spotifyMod = (SpotifyMod) YolBi.INSTANCE.getModuleCollection().get(SpotifyMod.class);
            arraylistMod = (ArrayListMod) YolBi.INSTANCE.getModuleCollection().get(ArrayListMod.class);
        }

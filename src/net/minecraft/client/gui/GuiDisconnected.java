...
public class GuiDisconnected extends GuiScreen {
    ...
    public GuiDisconnected(GuiScreen screen, String reasonLocalizationKey, IChatComponent chatComp) {
        ...
        Alt activeAlt = YolBi.INSTANCE.getAltManager().currentSessionAlt;
        if (activeAlt != null) {
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.id == 0) {
            ...
            mc2.displayGuiScreen(YolBi.INSTANCE.getAltManager());
        } else if (button.id == 2) {
            if (ServerUtils.lastServer != null) {
                mc2.displayGuiScreen(new GuiConnecting(new GuiMultiplayer(new MainMenu()), mc2, ServerUtils.lastServer));
            }
        }
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        YolBi.INSTANCE.getModuleCollection().getModule(NotificationsMod.class).render();

...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdate() {
        YolBi.INSTANCE.getEventProtocol().handleEvent(new UpdateEvent());
    ...
    public void onUpdateWalkingPlayer() {
        ...
        if (this.isCurrentViewEntity()) {
            ...
            YolBi.INSTANCE.getEventProtocol().handleEvent(motionEvent);
    ...
    public void sendChatMessage(String message) {
        if (YolBi.INSTANCE.getCommandHandler().execute(message) || message.startsWith(CommandHandler.CHAT_PREFIX)) {
            return;
        }

        PlayerSendMessageEvent playerSendMessageEvent = new PlayerSendMessageEvent(message);
        YolBi.INSTANCE.getEventProtocol().handleEvent(playerSendMessageEvent);
    ...
    protected boolean pushOutOfBlocks(double x, double y, double z) {
        ...
        YolBi.INSTANCE.getEventProtocol().handleEvent(pushOutOfBlockEvent);
    ...
    public void onLivingUpdate() {
        ...
        if (this.isUsingItem() && !this.isRiding()) {
            ...
            YolBi.INSTANCE.getEventProtocol().handleEvent(slowDownEvent);
    ...
    public void moveEntity(double x, double y, double z) {
        ...
        YolBi.INSTANCE.getEventProtocol().handleEvent(event);
    ...
    public void jump() {
        ...
        YolBi.INSTANCE.getEventProtocol().handleEvent(jumpEvent);

...
import dev.tenacity.protection.Initializer;
...
@MainClass
public class Main {
    public static String OsMame = System.getProperty("os.name");
    ...
    public static void main(String[] args) {
        ...
        OptionSpec<File> optionspec2 = optionparser.accepts("gameDir").withRequiredArg().ofType(File.class).defaultsTo(new File(new File("").getAbsolutePath()));
        ...
        OptionSpec<String> optionspec9 = optionparser.accepts("username").withRequiredArg().defaultsTo("YolBi" + Minecraft.getSystemTime() % 1000L);
